<div class="page-inner">
    <div class="page-title">
        <h3>
			<a href="<?php echo base_url(); ?>admin/pricerateincentivereport" style="text-decoration: none;">
				Price Rate Incentive Report
			</a>
		</h3>
    </div>
	<div id="main-wrapper">
			...
			<div class="col-md-12">
				<div class="panel panel-white">
	                <div class="panel-heading clearfix">
	                    <h4 class="panel-title">Price Rate Incentive Report</h4>
	                </div>
	                <div class="panel-body">
	                    <form class="form-horizontal" id="reportForm" method="POST" action="<?php echo base_url(); ?>admin/getPriceRateIncentiveReport" target="_blank">
	                    	<div class="row">
	                    		<div class="col-md-6">
...
<script>
	...
	{
		location.href = "<?php echo base_url(); ?>admin/pricerateincentivereport";
	});
