<div class="page-inner">
    <div class="page-title">
        <h3>
			<a href="<?php echo base_url(); ?>admin/piecelogreport" style="text-decoration: none;">
				Piecelog Report
			</a>
		</h3>
    </div>
			...
			<div class="col-md-12">
				<div class="panel panel-white">
	                <div class="panel-heading clearfix">
	                    <h4 class="panel-title">Piecelog Report</h4>
	                </div>
	                <div class="panel-body">
	                    <form class="form-horizontal" id="piecelogReportForm" method="POST" action="<?php echo base_url(); ?>admin/getPiecelogReport" target="_blank">
	                    	<div class="row">
	                    		<div class="col-md-6">
...
<script>
	...
	{
		location.href = "<?php echo base_url(); ?>admin/piecelogreport";
	});
