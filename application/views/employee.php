<div class="page-inner">
    <div class="page-title">
        <h3>
			<a href="<?php echo base_url(); ?>admin/employee" style="text-decoration: none;">
				Employees
			</a>
		</h3>
    </div>
	...
	<div id="main-wrapper">
        ...
        <div class="row" id="entryDetails" <?php echo $displayblock; ?>>
			<div class="col-md-12">
				<div class="panel panel-white">
	                <div class="panel-heading clearfix">
	                    <h4 class="panel-title">Employee Creation Form</h4>
	                </div>
	                <div class="panel-body">
	                    <form class="form-horizontal" id="employeeForm" method="POST">
							<div class="form-group">
	                            <label class="col-sm-2 control-label">
									Employee ID&nbsp;<span style="color: red;">*</span>
								</label>
	                            <div class="col-sm-6">
	                                <input type="text" class="form-control" id="empNo" name="empNo" placeholder="Employee No." value="<?php echo $empNo; ?>" required="">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label">
	                            ...
	                            <div class="col-sm-6">
	                                <input type="text" class="form-control" id="empName" name="empName" placeholder="Employee Name" value="<?php echo $empName; ?>" required="">
	                            </div>
	                        </div>
	                        <div class="form-group">
...
<script>
	...
	$(".editEntry").click(function()
	{
		...
		if(empId > 0)
		{
			location.href = '<?php echo base_url(); ?>admin/employee/'+empId;
		}
	});
	...
	function showResponse(data)
	{
		...
		else
		{
			...
			redirectURL = '<?php echo base_url(); ?>admin/employee';
		}
		$("#responseMsg").html(str);
		if(!isError)
		{
	...
	{
		$("#responseMsg").html('');
		location.href = '<?php echo base_url(); ?>admin/employee/';
	});
