...
<head>
        ...
        <!-- Title -->
        <title><?php echo $this->config->item('projectTitle'); ?> | Forgot Password</title>
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="<?php echo base_url(); ?>" class="logo-name text-lg text-center">Tracking System</a>
                                <p class="text-center m-t-md">Enter your e-mail address below to reset your password</p>
                                <form class="m-t-md" id="forgotPassword" method="post" action="">
