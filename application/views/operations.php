<div class="page-inner">
    <div class="page-title">
        <h3>
			<a href="<?php echo base_url(); ?>admin/operation" style="text-decoration: none;">
				Operations
			</a>
		</h3>
    </div>
	...
	<div id="main-wrapper">
			...
			<div class="col-md-12">
				<div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">Operations Details</h4>
                        ...
                        <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
							...
							if(count($allOperations) > 0)
							{
								...
								<tr>
									...
									<td><?php echo $row->operationdesc; ?></td>
									<td>
        ...
        <div class="row" id="entryDetails" <?php echo $displayblock; ?>>
			<div class="col-md-12">
				<div class="panel panel-white">
	                <div class="panel-heading clearfix">
	                    <h4 class="panel-title">Operation Creation Form</h4>
	                </div>
	                <div class="panel-body">
	                    <form class="form-horizontal" id="operationForm" method="POST">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-6">
	                                <textarea class="form-control" id="operationDesc" name="operationDesc" placeholder="Operation Desc"><?php echo $operationDesc; ?></textarea>
	                            </div>
	                        </div>
	                        <div class="form-group">
...
<script>
	...
	$("#operationForm").submit(function(e)
	{
		...
		var operationId = '<?php echo $operationId; ?>';
	...
	$(".editEntry").click(function()
	{
		...
		if(operationId > 0)
		{
			location.href = '<?php echo base_url(); ?>admin/operation/'+operationId;
		}
	});
	...
	function showResponse(data)
	{
		...
		else
		{
			...
			redirectURL = '<?php echo base_url(); ?>admin/operation';
		}
		$("#responseMsg").html(str);
		if(!isError)
		{
	...
	{
		$("#responseMsg").html('');
		location.href = '<?php echo base_url(); ?>admin/operation/';
	});
